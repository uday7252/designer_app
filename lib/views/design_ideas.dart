...
class DesignIdeasScreen extends StatefulWidget {
  const DesignIdeasScreen({super.key});

  @override
  State<DesignIdeasScreen> createState() => _DesignIdeasScreenState();
}

class _DesignIdeasScreenState extends State<DesignIdeasScreen>
